...
export const SITE_COPY_SECTIONS: SiteCopySection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "download.android_cta", label: "Android button" },
      ...
      { key: "download.ios_cta", label: "iOS button" },
    ],
  },
  {
    id: "contact",
...
export const DEFAULT_SITE_COPY: SiteCopyMap = {
  ...
  "download.android_body": "Download the QRZ APK from the website.",
  "download.android_cta": "Download APK",
  "download.ios_title": "iPhone (iOS)",
  "download.ios_subtitle": "QRZ for iOS",
  "download.ios_body": "Download the QRZ app for iPhone from the website.",
