...
export const SITE_COPY_SECTIONS: SiteCopySection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "download.play_protect_title", label: "Play Protect title" },
      { key: "download.play_protect_body", label: "Play Protect body", multiline: true },
      { key: "download.play_protect_step1", label: "Play Protect step 1" },
      { key: "download.play_protect_step2", label: "Play Protect step 2" },
      { key: "download.play_protect_step3", label: "Play Protect step 3" },
...
export const DEFAULT_SITE_COPY: SiteCopyMap = {
  ...
  "download.play_protect_title": "Google Play Protect warning?",
  "download.play_protect_body":
    "This is normal for apps downloaded from the website (not Google Play). QRZ is safe — Android just does not recognize the developer yet.",
  "download.play_protect_step1": "Tap More details (do not tap OK).",
  "download.play_protect_step2": "Tap Install anyway.",
  "download.play_protect_step3": "Finish the install and open QRZ from your home screen.",
